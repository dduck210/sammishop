...
class ShippingController extends Controller
{
  public function index()
  {
    ...
    $carts = $order_model->listOrderByDeliveryUserId($adminUserId, $pageSize, $page);

    $deliveryUsers = $order_model->getDeliveryUsersList();
    $this->content = $this->render("Mvc/backend/views/shipping/index.php", [
      "carts" => $carts,
      "numPage" => $numPage,
      "page" => $page,
  ...
  public function search()
  {
    ...
    if (isset($_POST["query"]) && $_POST["query"] != "") {
      ...
      $this->content = $this->render("Mvc/backend/views/shipping/search.php", [
        "carts" => $carts,
        "numPage" => $numPage,
        "page" => $page,
        "deliveryUsers" => $deliveryUsers
      ...
      $this->content = $this->render(
        "Mvc/backend/views/shoppingcart/search.php",
        [
          "carts" => $carts,
          "numPage" => $numPage,
          "page" => $page
