...
class ExpirationDateController extends Controller
{
    ...
    public function index()
    {
        ...
        // Lấy ngày cách ngày hiện tại 60 ngày
        $threeDaysFromNow = date("Y-m-d", strtotime($currentDate . "+60 days"));

        $countProduct = $product_model->countTotalExpiringWithinThreeDays($currentDate, $threeDaysFromNow);
        $numPage = ceil($countProduct / $pageSize);

        $products = $product_model->getAllExpiringWithinThreeDays($currentDate, $threeDaysFromNow, $pageSize, $page);
        ...
        $this->content = $this->render('Mvc/Backend/views/expirationDate/index.php', $output);
    ...
    public function detail()
    {
        ...
        $this->content = $this->render('Mvc/Backend/views/products/detail.php', [
            "product" => $product,
    ...
    public function create()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($this->error)) {
                ...
                $product_model->expiration_date = $expiration_date;
