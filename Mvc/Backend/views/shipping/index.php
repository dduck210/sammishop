  ...
  <table class="table table-bordered">
    <thead>
      <tr class="table-active">
        ...
        <th style="width: 10%;" scope="col">Xác nhận giao hàng</th>
          ...
          <tr>
            ...
            <td style="text-align: center">
                ...
                <?php if ($cart["status"] == 1) : ?>
                    <a onclick="return confirm('Xác nhận giao hàng thành công?')" href="index.php?area=backend&controller=shipping&action=send_status&id=<?php echo $cart["id"]; ?>"><i class="fa fa-check-circle"></i></a>
                <?php elseif ($cart["status"] == 0) : ?>
