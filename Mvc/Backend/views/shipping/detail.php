...
<div class="box">
  ...
  <div>
    <a style="margin-left: 15px" href="<?php echo ($_SESSION["user_admin"]["status"] == 2) ? 'index.php?area=backend&controller=shipping' : 'index.php?area=backend&controller=ShoppingCart'; ?>" class="btn btn-primary">Quay lại</a>
</div>
