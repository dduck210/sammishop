<section class="content-header" style="margin-bottom: 15px;">
  <h1>
    Danh sách sản phẩm tới hạn sử dụng
    <small>SammiShop</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="index.php?area=backend"><i class="fa fa-home"></i> Trang Chủ</a></li>
    <li class="active"> <i class="fa fa-address-book"></i>  Sản phẩm tới hạn</li>
  </ol>
</section>
        ...
        <tr>
          ...
          <?php if(!empty($products)): ?>
              ...
              <tr style="text-align: center">
                ...
                <td><?php echo date('d/m/Y - H:i:s', strtotime($product['expiration_date'])); ?></td>
